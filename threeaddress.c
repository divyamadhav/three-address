...
void main()
{
	...
	char nextInstr[50], gotokey[25], startKey[25], prevstartKey[25], prevgotokey[25];
	...
	while(fgets(nextInstr, sizeof(nextInstr), fp) != NULL )
	{
		countInstr++;
